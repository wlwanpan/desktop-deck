...
var { memberChannelView } = require('./js/views/memberChannelView')

var { Store } = require('./js/models/store')
var { Account } = require('./js/models/account')

var API = require('./js/api/apiGen')
...
var AppView = Backbone.View.extend ({
  ...
  renderAlert: function (error) {
    // To implement a custom alert dialog
    console.log(error)
  },
  ...
  _memberChannelPage: function (currentGame) {
    new memberChannelView ({ app: this, $wrapper: this.$window, currentGame })
  },
