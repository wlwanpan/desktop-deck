...
exports.chatRoomView = Backbone.View.extend ({
  ...
  _initListeners: function () {
    ...
    this.listenTo(this.model, 'change:message', this._testing, this)
  },

  _testing: function (options) {
    console.log (options)
  },

  _renderMessage: function (username, message) {
    this.model.publishToChat ({ message })
  ...
  sendMessage: function (e) {
    ...
    if (this.inputMessage.val().length > 0) {
      this.model.publishToChat({ message: this.inputMessage.val() })
