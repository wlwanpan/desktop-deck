...
exports.mainView = Backbone.View.extend ({
  ...
  initialize: function (options) {
    ...
    this.listenTo( this.store.players, 'change:shoutout', this._triggerNotification )
  },

  _triggerNotification: function (player) { new notificationView ({ $wrapper: this.$windowHeader, model: player }) },
